...
require app_path() . "/Actions/Azure/phpseclib/phpseclib/phpseclib/Crypt/RSA.php";

use App\Actions\Azure\EndpointHandler as Endpoints;
use Crypt_RSA;
...
class TokenChecker
{
    ...
    function __construct($request)
    {
        ...
        $this->endpointHandler = new Endpoints($request);
        $this->splitIdToken($request->token);
    }
